...
class LogRequestInfoMiddleware(starlette.middleware.base.BaseHTTPMiddleware):
    ...
    ERROR_HTTP_CODES = range(
        http_status.HTTP_400_BAD_REQUEST,
        http_status.HTTP_511_NETWORK_AUTHENTICATION_REQUIRED + 1,
    )
    ...
    async def dispatch(
        ...
        try:
            ...
            request_total = round(
                time1 - g.extra_info_for_logs.get("_request_start", 0), 3
            )
